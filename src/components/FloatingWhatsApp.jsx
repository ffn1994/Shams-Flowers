...
/** زر واتساب عائم يتابع الزائر وهو ينزل بالصفحة */
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-5 end-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lift transition duration-200 ease-soft hover:scale-105 hover:bg-[#1eb757] sm:h-16 sm:w-16"
    >
