...
/**
 * زر تواصل واتساب
 * WhatsApp contact button. `variant` controls the visual weight.
 */
export default function WhatsAppButton({
  message,
  variant = 'primary',
  className = '',
  children = 'تواصل معنا واتساب',
}) {
  const styles = {
    primary: 'btn bg-[#25D366] text-white shadow-soft hover:bg-[#1eb757] hover:shadow-lift',
    outline: 'btn-outline',
    light: 'btn bg-white text-brand-700 shadow-soft hover:bg-brand-50',
  };
