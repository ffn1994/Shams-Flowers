...
4. **باقات مختارة** — أربع بطاقات مع سعر يبدأ من وزر طلب مباشر على الواتساب.
...
3. **الأسعار في `src/data/home.js` مؤقتة** — بدّلها بأسعار المحل الحقيقية.
4. **رسومات الورد في `src/assets/bouquets/` مؤقتة** — بدّلها بصور المنتجات الحقيقية.
